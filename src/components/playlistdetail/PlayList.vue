<template>
  <div class="play-list-container"
       v-if="playListTable.length !== 0">
    <div class="handle clearfix">
      <span v-if="isShowCollection"
            @click="setPlayListCollection"
            :class="{'active-collec': subscribed}">
        <i class="iconfont iconshoucang"></i>
        {{collec}}
      </span>
      <span class="active-handle"
            @click="playAll">
    ...
    <table class="play-list">
      ...
      <tbody>
        <tr v-for="(item, index) in playListTable"
            :key="item.id">
          <td>
            <play-button :item="item"
                         :index="index"
                         :playList="playListTable"></play-button>
          </td>
          <td>
            <div class="avatar">
              <div class="cover">
