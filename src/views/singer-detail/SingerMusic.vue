<template>
  <div class="singer-music">
    <play-list :play-list-table="playList"
               :isShowCollection="false"></play-list>
  </div>
</template>

<script>
import PlayList from '../../components/playlistdetail/PlayList.vue'
export default {
  name: "SingerMusic",
  components: { PlayList },
  data () {
  ...
  created() {
    this.getSingerSingle(this.$route.params.id)
  }
}
</script>
