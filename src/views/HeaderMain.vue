  ...
  <div class="header-main">
    <div class="box">
      ...
      <ul>
        <li>
          <router-link to="/home"
                       tag="a">发现音乐</router-link>
        </li>
        <li>
          <router-link to="/rank"
                       tag="a">排行榜</router-link>
        </li>
        <li>
          <router-link to="/song_sheet"
                       tag="a">歌单</router-link>
        </li>
        <li>
          <router-link to="/singer"
                       tag="a">歌手</router-link>
        </li>
        <li>
          <router-link to="/video"
                       tag="a">视频</router-link>
        </li>
        <li>
          <router-link to="/mv"
                       tag="a">MV</router-link>
        </li>
      </ul>
      <div class="search">
    ...
    <div class="search-wrapper"
      ...
      <div class="search-container"
          ...
          <div class="content">
            <ul>
              <li v-for="(item, index) in historySearch"
                ...
                <span>{{item}}</span>
                <i class="iconfont iconclear"
                   @click.stop="deleteTag(index)"></i>
              </li>
            </ul>
          </div>
        </div>
        <div class="hot-search">
          ...
          <div class="content">
            <ul>
              <li v-for="item in hotSearchList"
                  :key="item.first"
