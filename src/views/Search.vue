<template>
  <div class="search-page">
    ...
    <router-view v-if="!isLoading"
                 ...
                 class="search-child-pages"></router-view>
...
export default {
  ...
  created () {
    ...
    this.getSearchData(this.keywords, type)
  },
  methods: {
    // 搜索
    search () {
      ...
      this.getSearchData(this.inputValue, type)
    },
    // 切换标签
    changeTag (path, type) {
    ...
    // 获取搜索数据
    async getSearchData (value, type) {
      try {
        let params = {
          keywords: value,
          limit: 30,
