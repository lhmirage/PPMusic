<template>
  <div class="singer">
    <div v-if="!isLoading">
      <category-container :category="singerCategory"
                          @switchTag="switchTag"
                          :activeIndex="activeIndex"></category-container>
...
export default {
  name: 'Singer',
  components: { Loading, CategoryContainer, SingerList },
  data () {
    return {
      singerParams: {
        limit: 40,
