<template>
  <div class="mv">
    <div v-if="!isLoading">
      <category-container :category="mvCategory"
...
<script>
import CategoryContainer from '../components/common/CategoryContainer.vue'
import Loading from '../components/common/Loading.vue'
import VideoList from '../components/common/VideoList.vue'
export default {
  name: "MV",
  components: { CategoryContainer, VideoList, Loading },
  data () {
    return {
      mvList: [],
      mvParamas: {
